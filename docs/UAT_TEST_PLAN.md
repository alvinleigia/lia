...
| Appointment lifecycle | Live booking, reschedule, occupied-slot alternatives, cancellation and zero/one/multiple-match lookup passed. Fresh intervening-booking recovery passed; a fresh 15-minute pause and simultaneous provider-write race remain separate gates. | Initial attempts 163, 170, 175 and 176; on `7920ca1`, attempts 185/192 created synthetic bookings, conflict and multiple-match reviews retained context, cleanup attempts 202/206 succeeded and attempt 207 found no match. See the calendar evidence document. |
