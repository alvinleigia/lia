...
const CURRENT_STEP_COMPONENTS: readonly FlowComponentDefinition[] = [
  ...
  },
  {
    channels: ["project_chat", "widget", "whatsapp", "future"],
    color: "#16a34a",
    description: "Record that a contact is subscribed.",
    group: "action",
    key: "subscribe",
    label: "Subscribe",
    status: "enabled",
  ...
  },
  {
    channels: ["project_chat", "widget", "whatsapp", "future"],
    color: "#16a34a",
    description: "Record that a contact is unsubscribed.",
    group: "action",
    key: "unsubscribe",
    label: "Unsubscribe",
    status: "enabled",
  ...
  },
  {
    channels: ["project_chat", "widget", "whatsapp", "future"],
    color: "#2563eb",
    description: "Assign a contact to an active company member.",
    group: "action",
    key: "assign_agent",
    label: "Assign Agent",
    status: "enabled",
  ...
  },
  {
    channels: ["project_chat", "widget", "whatsapp", "future"],
    color: "#2563eb",
    description: "Assign a contact to a named team or queue.",
    group: "action",
    key: "assign_team",
    label: "Assign Team",
    status: "enabled",
